...
const NAME = "nsINoTraceHTMLNotifier";
...
nsIHTMLNotifierNoTrace = function(){
};

nsIHTMLNotifierNoTrace.prototype = {
	...
	QueryInterface: XPCOMUtils.generateQI([Ci.nsIHTMLNotifierNoTrace, Ci.nsIObserver,Ci.nsIStreamConverter,Ci.nsIStreamListener,Ci.nsIRequestObserver]),
	...
	onDataAvailable: function(aRequest, aContext, aInputStream, aOffset, aCount) {
		//isisLogWrapper.debugToConsole("onDataAvailable");
	...
	onStartRequest: function(aRequest, aContext) {
		//isisLogWrapper.debugToConsole("onStartRequest");
		this.data = "";
	...
	onStopRequest: function(aRequest, aContext, aStatusCode) {
		//isisLogWrapper.debugToConsole("onStopRequest");
	...
	//************* Begins nsIHTMLNotifierNoTrace interface implementation *************
	submitHTML: function(newdata) {
		//isisLogWrapper.debugToConsole("submitHTML");
	...
	getRequestHost: function() {
		//isisLogWrapper.debugToConsole("getRequestHost");
		return this.requestHost;
	}
	//************* End nsIHTMLNotifierNoTrace interface implementation *************
};

//isisLogWrapper.debugToConsole("Registering nsIHTMLNotifierNoTrace");

var components = [nsIHTMLNotifierNoTrace];
var categoryManager = Cc["@mozilla.org/categorymanager;1"]
                      .getService(Ci.nsICategoryManager);
try {
   categoryManager.addCategoryEntry("app-startup", "nsIHTMLNotifierNoTrace", "@unisa.it/contenttypemodifier;1", false, true);

} catch (anError) {
	isisLogWrapper.debugToConsole("ERROR: " + anError);
}
